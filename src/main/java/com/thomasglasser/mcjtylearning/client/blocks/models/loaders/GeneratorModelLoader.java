...
{
    public static final ResourceLocation GENERATOR_LOADER = new ResourceLocation(McJtyLearning.MODID, "generatorloader");

    public static final ResourceLocation GENERATOR_FRONT_POWERED = new ResourceLocation(McJtyLearning.MODID, "block/generator_front_powered");
    public static final ResourceLocation GENERATOR_FRONT = new ResourceLocation(McJtyLearning.MODID, "block/generator_front");
    public static final ResourceLocation GENERATOR_SIDE = new ResourceLocation(McJtyLearning.MODID, "block/generator_side");
    public static final ResourceLocation GENERATOR_ON = new ResourceLocation(McJtyLearning.MODID, "block/generator_on");
    public static final ResourceLocation GENERATOR_OFF = new ResourceLocation(McJtyLearning.MODID, "block/generator_off");
