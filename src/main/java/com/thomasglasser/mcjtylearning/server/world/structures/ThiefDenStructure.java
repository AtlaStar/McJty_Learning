package com.thomasglasser.mcjtylearning.server.world.structures;
...
public class ThiefDenStructure extends Structure
{
    ...
    public ThiefDenStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter)
    {
        super(config);
